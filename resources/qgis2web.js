...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [13156606.859162, 2798557.524038, 13190778.808129, 2819847.713257], maxZoom: 20, minZoom: 1
    })
});
...
map.getView().fit([13156606.859162, 2798557.524038, 13190778.808129, 2819847.713257], map.getSize());
